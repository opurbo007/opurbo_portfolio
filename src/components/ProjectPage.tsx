      ...
      {projectList.map((item) => (
        <div
          ...
          className="group flex flex-col rounded-2xl
            ...
            hover:shadow-xl hover:shadow-purple-100 dark:hover:shadow-purple-500/10
          ...
          <div className="flex flex-col flex-1 p-5 gap-3">
            ...
            <div className="flex flex-wrap gap-1.5">
              {item.stack.map((tech, i) => (
                <span
                  key={i}
                  className="px-2 py-0.5 rounded-md bg-purple-50 dark:bg-purple-500/10 border border-purple-200 dark:border-purple-500/20 text-purple-700 dark:text-purple-400 text-[10px] font-semibold"
                >
                  {tech}
                </span>
              ))}
